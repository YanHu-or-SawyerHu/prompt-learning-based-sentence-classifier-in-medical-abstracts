...
percentage_of_training_data = 0.2
import os
os.environ['CUDA_VISIBLE_DEVICES'] = '7'

for percentage_of_training_data in [0.05,0.1,0.2,0.5,1]:
  ...
  if percentage_of_training_data == 1:
    stop_PMID = '-1'
  else:
  ...
  with open(str(percentage_of_training_data),'w') as f:
    f.write(str(result.metrics))