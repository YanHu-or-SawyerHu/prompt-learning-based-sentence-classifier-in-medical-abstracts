...
percentage_of_training_data = 0.5
import os
...
# read data
data_dir = '/collab/yhu5/PICO_sentence_classification/HSLN-Joint-Sentence-Classification/data/RCT_200k/pubmed-rct/PubMed_200k_RCT_with_title/'
